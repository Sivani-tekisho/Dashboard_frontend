          ...
          <div className="glass-card p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="border-l-4 border-blue-500 pl-4 py-2">
                ...
                <button 
                  onClick={() => navigate('/meetings')}
                  className="mt-2 bg-blue-500 text-white px-4 py-1.5 rounded-lg hover:bg-blue-600 transition-colors text-sm"
                >
                  Join Meeting
                </button>
              </div>
          ...
          <div className="glass-card p-6">
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-blue-500 pl-4 py-2">
                ...
                <p className="text-sm text-blue-600">Overdue by 2 days</p>
                <button 
                  onClick={() => navigate('/meetings')}
                  className="mt-2 bg-blue-500 text-white px-4 py-1.5 rounded-lg hover:bg-blue-600 transition-colors text-sm"
                >
              ...
              <div className="border-l-4 border-blue-500 pl-4 py-2">
                ...
                <p className="text-sm text-blue-600">Overdue by 1 day</p>
                <button 
                  onClick={() => navigate('/meetings')}
                  className="mt-2 bg-blue-500 text-white px-4 py-1.5 rounded-lg hover:bg-blue-600 transition-colors text-sm"
                >
